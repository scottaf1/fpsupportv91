  ...
  return (
    <div className={classes.tech}>
      ...
      <div className={slideMode ? classes.fullWidth : classes.container}>
        <Title title="FINPRO IT " desc="FINPRO IT Text FINPRO IT Text FINPRO IT Text FINPRO IT Text " align="center" monocolor={slideMode && true} />
        <Grid container className={classes.root} spacing={3}>
          <Grid item sm={4} xs={12}>
            <div className={classNames(classes.wool, slideMode && classes.slideMode)}>
              ...
              <Typography variant="h5" className={classes.react}>FINPRO ITFINPRO ITFINPRO IT</Typography>
            </div>
            <div className={classNames(classes.wool, slideMode && classes.slideMode)}>
              <figure>
          ...
          <Grid item sm={4} xs={12}>
            <div className={classes.centerTech}>
              ...
              <Hidden smDown>
                <Button variant="contained" size="large" color="secondary">FINPRO IT </Button>
              </Hidden>
              <div className={classNames(classes.wool, slideMode && classes.slideMode)}>
                <figure>
